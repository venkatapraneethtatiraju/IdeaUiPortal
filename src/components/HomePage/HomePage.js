...
import RecentIcon from '../../images/miscellaneous.svg';
import profileIcon from '../../images/social-media.svg';
  ...
  render() {
    ...
    return (
      <div className="home-page">
        ...
        <Route exact  to="/request" component={AllRecentRequest} >
        ...
        <Route exact path="/management" component={AllRecentRequest} >
        <AllRecentRequest isCategoriesSelected={this.state.isCategoriesSelected} isUserSelected={this.state.isUserSelected} title={this.state.title} value={this.state} />
        </Route>
